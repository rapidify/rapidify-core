...
class BaseController {
  ...
  async create(req, res) {
    try {
      const data = await this.Model.create({ body: req.body });
  ...
  async update(req, res) {
    try {
      const data = await this.Model.update({ id: req.body.id, body: req.body });
  ...
  async delete(req, res) {
    try {
      const data = await this.Model.delete({ useSoftDelete: false, deleteDoc: req.body });
