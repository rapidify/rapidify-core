...
function DbResult({ isSuccess, statusCode, statusText, logLevel, total, data, message }) {
    class DbResult {
        success;
        statusCode;
        statusText;
        ...
        constructor({ isSuccess, statusCode, statusText, logLevel, total, data, message }) {
    ...
    return Object.freeze(
        new DbResult({ isSuccess, statusCode, statusText, logLevel, total, data, message })
    );
}
