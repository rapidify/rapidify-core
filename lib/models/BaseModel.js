...
const { LOG_LEVEL } = require('../logger/logger');
...
class BaseModel {
    ...
    constructor(model) {
        this.Model = model;
        this.filter = new Config().DB_RESULTSET_FILTER;
    }
...
function DbResult({ isSuccess, statusCode, statusText, LOG_LEVEL, total, data, message }) {
    class DbResult {
        success;
        statusCode;
        statusText;
        ...
        constructor({ isSuccess, statusCode, statusText, LOG_LEVEL, total, data, message }) {
    ...
    return Object.freeze(
        new DbResult({ isSuccess, statusCode, statusText, LOG_LEVEL, total, data, message })
    );
}
